      ...
      <section className="py-20 bg-black luxury-section">
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center mb-20">
            <div className="w-full md:w-1/2 bg-gradient-to-br from-zinc-900 to-black aspect-[4/3] flex items-center justify-center">
              <div className="text-red-600 text-5xl">CAR CARE</div>
            </div>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="border border-zinc-800 hover:border-red-600/30 transition-colors duration-300">
              <div className="flex flex-col md:flex-row border-b border-zinc-800">
                <div className="w-full md:w-1/3 p-4 bg-zinc-900/50 font-light">
                  会社名
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto luxury-subheading">
              カーケアジャパン本社へのアクセス情報です。
              ご来店の際は、事前にご予約いただくことをおすすめします。
            </p>
          </div>

          <div className="flex flex-col md:flex-row gap-12">
            <div className="w-full md:w-1/2 h-[400px] bg-zinc-900 flex items-center justify-center border border-zinc-800 hover:border-red-600/30 transition-colors duration-300">
              {/* 地図の代わりに表示するプレースホルダー */}
              <div className="text-center">
                <p className="text-gray-400 mb-4">Google Mapが表示されます</p>
            ...
            <div className="w-full md:w-1/2">
              ...
              <h3 className="text-2xl font-light mt-8 mb-6 luxury-heading">
                BUSINESS HOURS
              </h3>
              <div className="w-12 h-px bg-red-600 mb-6"></div>
              <div className="space-y-4 text-gray-400">
                ...
                <p>定休日: 土曜日/日曜日/祝日</p>
                <p>
                  ※ 年末年始・GW・お盆期間は営業時間が変更になる場合があります
                </p>
              </div>
            </div>
          </div>
