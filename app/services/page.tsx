          ...
          <div className="space-y-24">
            ...
            <div className="flex flex-col md:flex-row items-center gap-12">
              <div className="w-full md:w-1/2 relative">
                <div className="aspect-[4/3] overflow-hidden">
                  <Image
                    src="/meticulously-detailed-car-cabin.png"
                ...
                <div className="absolute -bottom-5 -right-5 w-24 h-24 bg-red-600 flex items-center justify-center">
                  <span className="text-white text-xl font-light">03</span>
                </div>
              </div>
              <div className="w-full md:w-1/2">
                <h3 className="text-2xl font-light mb-4 luxury-heading">
                ...
                <p className="text-gray-400 mb-6">
                  ...
                  専用の洗剤と道具を使用し、シート、ダッシュボード、ドアパネルなど、車内のあらゆる部分を美しく仕上げます。
                </p>
                <ul className="space-y-3 mb-8">
                  <li className="luxury-list-item">
                    レザーシートのクリーニングと保護
                  </li>
                  <li className="luxury-list-item">内装の徹底洗浄</li>
                  <li className="luxury-list-item">消臭・抗菌処理</li>
                  <li className="luxury-list-item">
                    ダッシュボードとトリムの保護
                  </li>
                </ul>
